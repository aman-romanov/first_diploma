...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="includes/status_handler.php" method="post" >
            <div class="row">
                <div class="col-xl-6">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name='status' class="form-control" id="example-select">
                                                <option <?php if($user[0]['status']=='Онлайн'){echo 'selected';}?> >Онлайн</option>
                                                <option <?php if($user[0]['status']=='Отошел'){echo 'selected';}?> >Отошел</option>
                                                <option <?php if($user[0]['status']=='Не беспокоить'){echo 'selected';}?> >Не беспокоить</option>
                                            </select>
                                        </div>
                                    </div>
